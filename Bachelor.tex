...
\makeglossaries 
\input{prolog/glossary}
\input{prolog/acronyms}
\makenomenclature
...
\begin{document}
    ...
    \input{prolog/Title}
    \newpage
    \input{prolog/Sperrvermerk}
    \newpage
    \input{prolog/Ehrenwoertliche_Erklaerung}
    \newpage
    \input{prolog/Zusammenfassung}
    \newpage
    ...
    \bibliography{bibtex-daten/Bachelor.bib}

    \appendix
    \input{appendix/jsonConfig.tex}
    \input{appendix/dockerConfig.tex}
