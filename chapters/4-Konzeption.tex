...
Neben der direkten Aktualisierung und der Pull-or-Push Aktualisierung, gibt es noch die Umsetzungsmöglichkeit mithilfe des \gls{cdc} - Pattern. Bei CDC handelt es sich um ein Software Design Pattern, welches die Datenintegration zwischen einer Datenbank und deren Datenquellen definiert.

https://datenbanken-verstehen.de/lexikon/change-data-capture/

\begin{description}
    \item[Change-Data-Capture:]\hfill \\
    Text
