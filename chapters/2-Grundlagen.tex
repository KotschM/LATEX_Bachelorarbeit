...
Neben den reinen Daten wachsen zunehmend auch die Anzahl der Websites und Web-Inhalten. So gibt es Stand 2021 rund 1,83 Milliarden Websites \cite{GuyFawkes.2021}, welche durch Suchmaschinen, wie Google durchsucht werden können. Ein Nutzer kann hierbei einen Volltext als Sucheingabe eingeben und erhält eine Liste mit den entsprechenden Treffern sortiert nach der Relevanz für den Nutzer.
...
Einen großen Beitrag zu einer hohen User Experience in modernen Informationssystemen liefert die Suchfunktionalität, mit welcher Websites und Softwaresysteme durchsucht werden können.

\subsection{Beispiele für die Volltextsuche\label{subsec2.3.1:Unterunterpunkt-1}}

Text

\subsection{Umsetzungsmöglichkeiten einer Volltextsuche\label{subec2.3.2:Unterunterpunkt-2}}
