...
Auch bei der Integration einer Volltextsuche in eine Microservice-Architektur gilt es die vorgestellten Anti-Pattern zu beachten, um so monolithische Seiteneffekte zu vermeiden.
...
Der Mehrwert bei der Einführung einer Suchfunktion in einer Website oder in einem Software-Produkt, wie \gls{mcc}, liegt bei der Unterstützung der Benutzer beim Navigieren. So können auch neue Benutzer bei der Suche nach Produkten oder Informationen unterstützt werden, obwohl diese den eigentlichen Umfang der Website beziehungsweise Software nicht kennen.

Je nach Art und Umfang der Produkte und Informationen bieten sich verschiedene Möglichkeiten einer Suchfunktion an. Der Benutzer hat die Möglichkeit entweder einen Volltext einzugeben und somit eine List mit Treffern zu erhalten oder durch die Filterung von Facetten zum gewünschten Treffer zu gelangen.

\subsection{Volltextsuche\label{subsec2.3.1:Unterunterpunkt-1}}

Eine Möglichkeit nach Produkten oder anderen Informationen zu suchen, ist die Volltextsuche. Hierbei kann der Benutzer einen beliebigen Text in ein Suchfeld eingeben und erhält eine Auflistung der Treffer, welche den eingegebenen Text enthalten.

Eine Volltextsuche wird von den Benutzern als gewohnter Komfort wahrgenommen, da auch Suchmaschinen wie Google, mit dieser Art der Suchfunktion agieren.

Eine Volltextsuche wird nicht nur klassischerweise in eCommerce-Websites angeboten, sondern auch für die Navigation und Suche in Software-Produkten. Ein Beispiel hierfür ist die Wiki-Software \glqq Atlassian Confluence\grqq{}, welche standardmäßig eine Suchfunktion zur Verfügung stellt. Für die Wissensaufnahme und Weitergabe der Firma Enisco wird genau diese Wiki-Software verwendet.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{images/Suchleiste_Confluence.png}
    \caption{Ergebnisse der Suchanfrage \glqq Studenten\grqq{}}
    \label{fig:search_confluence}
\end{figure}

Grundlage für die technische Umsetzung einer Volltextsuche ist die Erstellung eines invertierten Index.

\subsection{Facettierte Suche\label{subec2.3.2:Unterunterpunkt-2}}
