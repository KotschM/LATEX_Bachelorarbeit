...
Auch bei der Integration einer Search Engine in eine Microservice-Architektur gilt es die vorgestellten Anti-Pattern zu beachten, um so monolithische Seiteneffekte zu vermeiden.

\section{Volltextsuche in modernen Informationssystemen\label{sec2.3:Unterpunkt-3}}

Text

\subsection{Mehrwert einer Volltextsuche\label{subsec2.3.1:Unterunterpunkt-1}}
