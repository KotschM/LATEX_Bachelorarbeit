...
Aufbauend auf die Vorstellung verschiedener Möglichkeiten für die Umsetzung einer Suchfunktionalität aus \autoref{sec2.3:Unterpunkt-3}, wird in folgendem Kapitel der Suchumfang für die unterschiedlichen Möglichkeiten aufgezeigt.

Als Basis wird sich am Funktionsumfang der bestehenden MES-Lösung \glqq E-MES\grqq{} orientiert. Auch die Neugestaltung \glqq MCC\grqq{}, welche sich derzeit noch in der Entwicklungsphase befindet, wird den nahezu gleichen Umfang besitzen.

Folgend wird somit nach einer Einführung in den zukünftigen Produktumfang von \glqq MCC\grqq{} auch definiert, welche Informationen über die Suchfunktionalität gesucht werden können. Betrachtet werden die Suchfunktionalität \glqq Volltextsuche\grqq{}, \glqq facettierte Suche\grqq{}, \glqq semantische Suche\grqq{} und die Kombination \glqq facettierte Volltextsuche\grqq{}.

\section{Funktionsumfang von MCC\label{sec3.1:Unterunterpunkt-1}}



Da sich die Neugestaltung MCC vom Funktionsumfang der bestehenden MES-Lösung E-MES gleicht.

\subsection{Application Development Framework\label{subsec3.1.1:Unterunterpunkt-1}}

Text

\subsection{Core Services\label{subsec3.1.2:Unterunterpunkt-2}}
